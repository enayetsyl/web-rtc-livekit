...
import { ParticipantPermission, TrackSource as ProtoTrackSource } from '@livekit/protocol';
...
export default function Page() {
  ...
  const isLocalParticipant = (p: Participant): p is LocalParticipant => p.isLocal === true;
